...
if(isset($_POST['createproductbtn']))
{
    ...
    $query = "INSERT INTO products (product_name, product_amount, product_purchase_price, product_price_factor) VALUES ('$product_name', '$product_amount', '$product_purch_price', '$product_price_factor')";
