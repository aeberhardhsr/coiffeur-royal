...
if(isset($_POST['editcustomerbtn']))
{
    ...
    $query = "UPDATE customer SET customer_name='$customer_name', customer_vorname='$customer_vorname', customer_city='$customer_location', customer_zipcode='$customer_zipcode', customer_street='$customer_street' WHERE customer_id='$customer_id'";
