...
if(isset($_POST['editproductbtn']))
{
    ...
    $query = "UPDATE products SET product_name='$product_name', product_purchase_price='$product_purch_price', product_price_factor='$product_price_factor' WHERE product_id='$product_id'";
